...
describe('Basket e2e test', () => {
  ...
  it('should load Baskets', async () => {
    ...
    expect(await basketComponentsPage.getTitle()).to.eq('jhispterBiloungaaleckApp.basket.home.title');
  ...
  it('should load create Basket page', async () => {
    ...
    expect(await basketUpdatePage.getPageTitle()).to.eq('jhispterBiloungaaleckApp.basket.home.createOrEditLabel');
  ...
  it('should delete last Basket', async () => {
    ...
    expect(await basketDeleteDialog.getDialogTitle()).to.eq('jhispterBiloungaaleckApp.basket.delete.question');
