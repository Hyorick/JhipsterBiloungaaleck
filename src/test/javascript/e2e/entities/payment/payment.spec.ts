...
describe('Payment e2e test', () => {
  ...
  it('should load Payments', async () => {
    ...
    expect(await paymentComponentsPage.getTitle()).to.eq('jhispterBiloungaaleckApp.payment.home.title');
  ...
  it('should load create Payment page', async () => {
    ...
    expect(await paymentUpdatePage.getPageTitle()).to.eq('jhispterBiloungaaleckApp.payment.home.createOrEditLabel');
  ...
  it('should delete last Payment', async () => {
    ...
    expect(await paymentDeleteDialog.getDialogTitle()).to.eq('jhispterBiloungaaleckApp.payment.delete.question');
