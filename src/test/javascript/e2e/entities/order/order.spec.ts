...
describe('Order e2e test', () => {
  ...
  it('should load Orders', async () => {
    ...
    expect(await orderComponentsPage.getTitle()).to.eq('jhispterBiloungaaleckApp.order.home.title');
  ...
  it('should load create Order page', async () => {
    ...
    expect(await orderUpdatePage.getPageTitle()).to.eq('jhispterBiloungaaleckApp.order.home.createOrEditLabel');
  ...
  it('should delete last Order', async () => {
    ...
    expect(await orderDeleteDialog.getDialogTitle()).to.eq('jhispterBiloungaaleckApp.order.delete.question');
